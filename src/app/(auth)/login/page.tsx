...
export default function LoginPage() {
  ...
  return (
    <Card className="rounded-none border-4 border-black dark:border-white shadow-[8px_8px_0_0_#000] dark:shadow-[8px_8px_0_0_#fff]">
      <CardHeader className="text-center space-y-2 px-8 pt-8 rounded-none border-b-4 border-black dark:border-white pb-6 mb-6">
        <Typography
          variant="h2"
        ...
        <CardDescription className="text-black dark:text-white font-bold uppercase tracking-widest text-xs">
          Sign in to your <span className="uppercase">{role}</span> account
        </CardDescription>
      </CardHeader>
      <CardContent className="px-8 pb-8 space-y-6">
        ...
        >
          ...
          <button
            ...
            className={`flex h-11 items-center justify-center rounded-none border-2 px-4 text-sm font-black uppercase tracking-widest transition-all duration-200 ${
              isEmployer
                ? "border-black dark:border-white bg-[#AB47BC] text-white shadow-[4px_4px_0_0_#000] dark:shadow-[4px_4px_0_0_#AB47BC]"
                : "border-black dark:border-white bg-white dark:bg-black text-gray-500 hover:text-black dark:hover:text-white hover:shadow-[4px_4px_0_0_#000] dark:hover:shadow-[4px_4px_0_0_#fff] hover:-translate-y-[2px]"
            }`}
          >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            <Button
              variant="outline"
              type="button"
              className="h-11 px-2 sm:px-4 rounded-none border-2 border-black dark:border-white shadow-[2px_2px_0_0_#000] dark:shadow-[2px_2px_0_0_#fff] transition-all hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none bg-white dark:bg-black"
            ...
            >
              ...
              <span className="hidden min-[400px]:inline ml-1.5 font-bold uppercase tracking-widest text-xs">
                Google
              </span>
            </Button>
            <Button
