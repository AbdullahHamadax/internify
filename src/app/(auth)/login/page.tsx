    ...
    Employer
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <Button variant="outline" type="button" className="h-11 hover:bg-zinc-100 transition-colors" onClick={() => signInWithOAuth("oauth_google")}>
              ...
              <Button variant="outline" type="button" className="h-11 hover:bg-zinc-100 transition-colors" onClick={() => signInWithOAuth("oauth_linkedin_oidc")}>
              ...
              <Button variant="outline" type="button" className="h-11 hover:bg-zinc-100 transition-colors" onClick={() => signInWithOAuth("oauth_github")}>
