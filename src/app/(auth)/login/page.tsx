        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            <Button
              variant="outline"
              type="button"
              className="h-11 px-2 sm:px-4 transition-all hover:border-zinc-300 hover:bg-zinc-100 hover:shadow-sm dark:hover:border-gray-600 dark:hover:bg-gray-800"
            ...
            >
              ...
              <span className="hidden min-[400px]:inline ml-1.5">Google</span>
            </Button>
            <Button
              variant="outline"
              type="button"
            ...
            >
              ...
              <span className="hidden min-[400px]:inline ml-1.5">LinkedIn</span>
            </Button>
            <Button
              variant="outline"
              type="button"
            ...
            >
              ...
              <span className="hidden min-[400px]:inline ml-1.5">GitHub</span>
            </Button>
          </div>
