  ...
  return (
    <div className="w-full min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-[linear-gradient(135deg,#06b6d4_0%,#3b82f6_50%,#a855f7_100%)] p-12 text-white relative overflow-hidden">
        {/* Decorations */}
        <div className="absolute top-20 right-[-50px] w-64 h-64 bg-white/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-[-50px] left-[-50px] w-80 h-80 bg-blue-500/20 rounded-full blur-3xl pointer-events-none" />
      ...
      {/* RIGHT SIDE (no card wrapper here) */}
